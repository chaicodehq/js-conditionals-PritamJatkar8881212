...
export function canBorrowBook(memberAge, hasValidCard, overdueBooks) {
  ...
  if (!hasValidCard) return { allowed: false, message: "Invalid library card - please renew at the front desk" };
  if (overdueBooks > 0) return { allowed: false, message: `Please return your ${overdueBooks} overdue book(s) first` };
